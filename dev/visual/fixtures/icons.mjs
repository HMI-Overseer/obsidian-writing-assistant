import { addedIcon, icon } from "../lib/lucideIcons.mjs";
...
export const ICON_NAMES = {
  ...
  undo2: "undo-2",
  coffee: "coffee",
  // Settings section icons. Every settings tab passes its own icon to createSettingsSection, so a
  // surface that falls back to one generic glyph misreports the tab: see `section()` below.
  heart: "heart",
  fileDiff: "file-diff",
