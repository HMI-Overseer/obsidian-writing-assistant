 ...
 * core/tail split as per-tool `alwaysLoad` (ADR-0009). This is the Claude Code
 * analogue of the direct-API defer split: the
 ...
 * across posture changes. Extracted from {@link createVaultSdkMcpServer} so the split
